...
- ロード時間とメモリ使用量を減らすために、アセット読み込みのタイミングやその数を工夫した
- 今後の改善点としては、リザルトシーンの作りこみが甘いため、スコアの内訳を見れるようにしたり、これまでの記録も見れるようにしたりしたいと考えている
- また、もう1つ猫の動き方のバリエーションを考えているため、それの実現方法について考え、実装していきたいと考えている
