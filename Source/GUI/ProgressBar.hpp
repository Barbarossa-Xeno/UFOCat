...
{
	/// @brief プログレスバーのコンポーネント
	class ProgressBar : public Layoutable
	{
		/// @brief 進捗状況 (0 ~ 1)
	...
	public:
		...
		ProgressBar(const SizeF &size, const ColorF &color, LayoutMode layoutMode = LayoutMode::Absolute, double roundness = 9.0, double progress = 0.0);
		...
		/// @return 
		ProgressBar &set(const SizeF &size, const ColorF &color, LayoutMode layoutMode = LayoutMode::Absolute, double roundness = 9.0);
