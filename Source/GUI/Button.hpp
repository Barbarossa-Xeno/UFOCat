...
namespace UFOCat::GUI
{
	...
	class Button : public Layoutable
	{
	...
	public:
		...
		Button(const Font &font, double fontSize, const String &text, const Audio &se, LayoutMode layoutMode = LayoutMode::Absolute, bool isEnabled = true, const Vec2 &padding = { 30.0, 10.0 });
		...
		/// @param isEnabled 有効かどうか
		/// @param padding ボタンの内側余白 (デフォルトは (30, 10))
		Button(double fontSize, const String &text, const Audio& se, LayoutMode layoutMode = LayoutMode::Absolute, bool isEnabled = true, const Vec2 &padding = { 30.0, 10.0 });
		...
		/// @param isEnabled 有効かどうか
		/// @param padding ボタンの内側余白 (デフォルトは (30, 10))
		Button(const Font &font, double fontSize, const String &text, LayoutMode layoutMode = LayoutMode::Absolute, bool isEnabled = true, const Vec2 &padding = { 30.0, 10.0 });
		...
		Button &set(const Font &font, double fontSize, const String &text, const Audio &se, LayoutMode layoutMode = LayoutMode::Absolute, bool isEnabled = true, const Vec2 &padding = { 30.0, 10.0 });
		...
		/// @param isEnabled 有効かどうか
		/// @param padding ボタンの内側余白 (デフォルトは (30.0, 10.0))
		Button &set(double fontSize, const String &text, const Audio& se, LayoutMode layoutMode = LayoutMode::Absolute, bool isEnabled = true, const Vec2 &padding = { 30.0, 10.0 });
		...
		/// @param isEnabled 有効かどうか
		/// @param padding ボタンの内側余白 (デフォルトは (30.0, 10.0))
		Button &set(const Font &font, double fontSize, const String &text, LayoutMode layoutMode = LayoutMode::Absolute, bool isEnabled = true, const Vec2 &padding = { 30.0, 10.0 });
		...
		/// @param isEnabled 有効かどうか
		/// @param padding ボタンの内側余白 (デフォルトは (30.0, 10.0))
		Button &set(double fontSize, const String &text, LayoutMode layoutMode = LayoutMode::Absolute, bool isEnabled = true, const Vec2 &padding = { 30.0, 10.0 });
